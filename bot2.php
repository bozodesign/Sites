                        ...
                        case "aaa":
                            ...
                            $actionBuilder = array(
                                                   new PostbackTemplateActionBuilder(
                                                                                     '1.ยังไม่รู้จะเลือกอะไร', // ข้อความแสดงในปุ่ม
                                                   ...
                                                   new PostbackTemplateActionBuilder(
                                                                                     '2.เลือกไม่ถูกจะซื้ออะไร', // ข้อความแสดงในปุ่ม
                                                                                     http_build_query(array(
                                                                                                            'action'=>'ans',
                                                                                                            'item'=>100
                                                                                                            )) // ข้อมูลที่จะส่งไปใน webhook ผ่าน postback event
                            ...
                            $imageUrl = 'https://png.icons8.com/color/2x/about/5';
                            $replyData = new TemplateMessageBuilder('Button Template',
                                                                    new ButtonTemplateBuilder(
                                                                                              'ตัวเลือกในข้อใดต่อไปนี้ไม่สามารถตอบได้', // กำหนดหัวเรื่อง
                                                                                              ' ', // กำหนดรายละเอียด
